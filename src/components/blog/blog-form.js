...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "",
            apiUrl: "https://chrisdecker.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post"
        };
    ...
    componentWillMount() {
        if (this.props.editMode) {
            this.setState({ 
                ...
                apiUrl: `https://chrisdecker.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
                apiAction: "patch"
            });
        }
    }
        ...
        return (
            <form onSubmit={this.handleSubmit} className="blog-form-wrapper">
                ...
                <div className="one-column">
                    <RichTextEditor handleRichTextEditorChange={this.handleRichTextEditorChange} editMode={this.props.editMode} contentToEdit={
